...
<fmt:message bundle="${loc}" key="lPassword" var="lPassword"/>
    ...
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
            ...
            <div class="table-responsive">
                <h2>${lPanelEdit}</h2>
                <table>
                    <form action="${pageContext.request.contextPath}/controller?command=update_person" method="POST">
                        <tr>
                            <td class="fw-bolder" width="200px">ID</td>
                            <td class="fw-bolder">
                                <c:set scope="session" var="userId" value="${requestScope.user.id}"/>
                                ${requestScope.user.id}
                            </td>
                        </tr>
                        <tr>
                            <td class="fw-bolder" width="200px">${lLogin}</td>
                            <td class="fw-bolder">
                                <input type="text" name="login" value="${requestScope.user.login}">
                            </td>
                        </tr>
                        <tr>
                            <td class="fw-bolder" width="200px">${lPassword}</td>
                            <td class="fw-bolder">
                                <input type="text" name="password" placeholder="entry new password">
                            </td>
                        </tr>
                        <tr>
                            <td class="fw-bolder" width="200px">${lName}</td>
                            <td class="fw-bolder">
                                <input type="text" name="name" value="${requestScope.account.name}">
                            </td>
                        </tr>
                        <tr>
                            <td class="fw-bolder" width="200px">${lSurName}</td>
                            <td class="fw-bolder">
                                <input type="text" name="surname" value="${requestScope.account.surname}">
                            </td>
                        </tr>
                        <tr>
                            <td class="fw-bolder" width="200px">${lEmail}</td>
                            <td class="fw-bolder">
                                <input type="text" name="email" value="${requestScope.account.email}">
                            </td>
                        </tr>
                        <tr>
                            <td class="fw-bolder" width="200px">${lPhone}</td>
                            <td class="fw-bolder">
                                <input type="text" name="phone" value="${requestScope.account.phone}">
                            </td>
                        </tr>
                        <tr>
                            <td class="fw-bolder" width="200px">${lDocId}</td>
                            <td class="fw-bolder">
                                <input type="text" name="documentId" value="${requestScope.account.documentId}">
                            </td>
                        </tr>
                        <tr>
                            <td class="fw-bolder" width="200px">${lDriveLicense}</td>
                            <td class="fw-bolder">
                                <input type="text" name="driveLicenseNumber" value="${requestScope.account.driveLicenseNumber}">
                            </td>
                        </tr>
                        <tr>
                            <td class="fw-bolder" width="200px">${lAddress}</td>
                            <td class="fw-bolder">
                        ...
                        <tr>
                            ...
                            <td class="fw-bolder">
                                <input type="text" name="balance" value="${requestScope.account.balance}">
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>
                                <button type="submit" class="btn btn-secondary btn-sm" id="btnUpdateUser">${lUpdate}</button>
                            </td>
                        </tr>
                    </form>
                </table>
