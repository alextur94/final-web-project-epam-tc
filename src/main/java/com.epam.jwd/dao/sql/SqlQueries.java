...
public interface SqlQueries {
    ...
    String SQL_FIND_USER_BY_ACCOUNT_ID = "SELECT id, login, password, account_id FROM user WHERE account_id = ?";
    ...
    String SQL_FIND_BY_RANGE = "SELECT id, brand, model, available, price_id FROM car LIMIT ?,?";
