...
public class Constant {
    ...
    public static final String PATH_PAGE_EDIT_USER = "/WEB-INF/jsp/edit_user.jsp";
    ...
    public static final String PATH_PAGE_ADMIN_WAITING_ORDERS = "/WEB-INF/jsp/admin_waiting_orders.jsp";
    ...
    public static final String COMM_CARS_PAGE = "/controller?command=cars_page";
    ...
    public static final String PASSWORD_OLD_PARAM = "passwordOld";
    public static final String PASSWORD_REPEAT_PARAM = "passwordRepeat";
    ...
    public static final String ERROR_FAILED_PASS_MSS = "Invalid password. ";
    ...
    public static final String SUCCESS_SAVE_PERSON_MSS = "Person was be updated. ";
