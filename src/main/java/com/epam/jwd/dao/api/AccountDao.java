...
public interface AccountDao extends Dao<Account, Integer> {
    ...
    Boolean saveTransactionUserAdmin(Account user, Account admin, Order order) throws DaoException;
    Boolean cancelOrder(Account account, Account admin, Car car, Order order) throws DaoException;
