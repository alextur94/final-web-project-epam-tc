...
public interface SqlQueries {
    ...
    String SQL_SAVE_USER = "INSERT INTO public.user (login, password, account_id) VALUES (?,?,?)";
    String SQL_UPDATE_USER_BY_ID = "UPDATE public.user SET login = ?, password = ?, account_id = ? WHERE id = ?";
    String SQL_DELETE_USER_BY_ID = "DELETE FROM public.user WHERE id = ?";
    String SQL_FIND_USER_BY_ID = "SELECT id, login, password, account_id FROM public.user WHERE id = ?";
    String SQL_FIND_ALL_USERS = "SELECT id, login, password, account_id FROM public.user";
    String SQL_FIND_USER_BY_LOGIN = "SELECT id, login, password, account_id FROM public.user WHERE login = ?";
    String SQL_FIND_USER_BY_ACCOUNT_ID = "SELECT id, login, password, account_id FROM public.user WHERE account_id = ?";
    ...
    String SQL_FIND_ORDER_BY_USER_ID = "SELECT id, status, rental_time, payment_status, rent_start_dtm, rent_end_dtm, start_level, end_level, refusal, pledge, current_sum, status_mark, user_id, car_id, mark_id, insurance_id FROM order_tab WHERE user_id = ? ORDER BY id DESC LIMIT ? OFFSET ?";
