...
<fmt:message bundle="${loc}" key="butReject" var="butReject"/>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-sm">
                    ...
                    <tr>
                        ...
                        <th>Sum</th>
                        <th>To approve</th>
                        <th style="text-align: center">Refusal</th>
                    </tr>
                    </thead>
                    <c:forEach var="order" items="${sessionScope.orderList}">
                        ...
                        <tr>
                            ...
                            <td>
                                <c:set scope="session" var="order" value="${order.id}"/>
                                <a href="${pageContext.request.contextPath}/controller?command=approve_car">${butApprove}</a>
                            </td>
                            <form action="${pageContext.request.contextPath}/controller?command=cancel_order_admin"
                                  method="POST">
                                <td>
                                    <input type="text" name="refusal" size="70">
                                    <input type="hidden" name="orderId" value="${order.id}">
                                    <button type="submit" class="btn btn-success">${butReject}</button>
                                </td>
                            </form>
                        </tr>
                        </tbody>
