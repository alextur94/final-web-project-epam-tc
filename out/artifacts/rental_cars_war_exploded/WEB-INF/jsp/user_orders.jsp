...
<fmt:message bundle="${loc}" key="lID" var="lID"/>
                        ...
                        <table class="table table-striped table-sm">
                            ...
                            <c:forEach var="order" items="${requestScope.orderList}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <c:choose>
                                            <c:when test="${order.paymentStatus eq 0 and order.status != Status.CLOSE.id}"><a href="${pageContext.request.contextPath}/controller?command=pay&orderId=${order.id}">${butPay}</a></c:when>
